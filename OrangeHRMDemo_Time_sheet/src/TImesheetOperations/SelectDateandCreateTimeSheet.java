...
public class SelectDateandCreateTimeSheet {
	...
	public void CallingBrowser() throws InterruptedException 
	{
	 ...
	 System.out.println("User can click the View button");
	  ...
	  @Test(priority=1)
	  public void Choosedateautomatically() throws InterruptedException
	  {
	  //duration to entering into the page
	  Thread.sleep(2000);
	   
	   
	  //identify the web elements for the Selection of the week
	  WebElement  SelectCalendar=driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/form/div[1]/div[2]/div/div/div[2]/div/div/i"));
	  SelectCalendar.click();
	  Thread.sleep(2000);
	  
	  //Identify the web elements for the month selection drop down
	  WebElement monthdropdwon=driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/form/div[1]/div[2]/div/div/div[2]/div/div[2]/div/div[1]/ul/li[1]/div"));
	  monthdropdwon.click();
	  Thread.sleep(2000);
	   
	  //identify the web element for the selection of month
	  WebElement  Selectmonth=driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/form/div[1]/div[2]/div/div/div[2]/div/div[2]/div/div[1]/ul/li[1]/ul/li[3]"));
	  Selectmonth.click();
	  Thread.sleep(2000);	   
	    
	  //identify the web elements for the dates in the calendar
	  WebElement dates=driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/form/div[1]/div[2]/div/div/div[2]/div/div[2]/div/div[3]/div[13]/div"));
	  dates.click();
	  Thread.sleep(5000);
	   
	  System.out.println("Dates is Selected for 13.03.2023");
	  ...
	  @Test(priority=2)
	  public void ChoosedateManually() throws InterruptedException
	  {
	  ...
	  WebElement ClickTimeSheetBtn=driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/form/div[3]/div[2]/button"));
	  ClickTimeSheetBtn.click();
	  Thread.sleep(6000);

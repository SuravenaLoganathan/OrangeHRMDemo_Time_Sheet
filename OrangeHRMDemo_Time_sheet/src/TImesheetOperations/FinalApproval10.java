...
public class FinalApproval10 {
	...
	@Test(priority=1)
    public void  ResetAction2() throws InterruptedException
    {
    //duration to entering into the page  
    Thread.sleep(12000);
    	
    //identify the web element to click on Reset button
    WebElement ResetCLK2=driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/form/div[3]/div[2]/button"));
    ResetCLK2.click();
    Thread.sleep(9000);
     
    //identify the web elements to find the edit button after Reset option
	WebElement EditAfterReset2=driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/form/div[3]/div[2]/button"));
    EditAfterReset2.click();
    Thread.sleep(15000);
	   
	//identify the web elements to find the delete button 
    WebElement deletebutton=driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/form/div[2]/table/tbody/tr[2]/td[10]/button"));
	deletebutton.click();
    Thread.sleep(20000);
	       
    //identify the web elements to save the project
    WebElement SAVE3=driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/form/div[3]/div[2]/button[3]"));
    SAVE3.click();
    Thread.sleep(12000); 
     
    System.out.println("Cliked the Reset button and deleted project2 for the final approval");
	 }
    
    
	@Test(priority=2)
    public void  TimeSheetAction3() throws InterruptedException
    {
    //duration to entering into the page  
    	Thread.sleep(12000);
    	
    //identify the web element to comment on approval sheet
     WebElement SheetApprove3=driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div[1]/form/div[1]/div/div/div/div[2]/textarea"));
     SheetApprove3.sendKeys("Final Approval");
     Thread.sleep(12000);
     
     
    //identify the web element to click on approval button
     WebElement ApproveCLK2=driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div[1]/form/div[2]/button[2]"));
     ApproveCLK2.click();
     Thread.sleep(12000);
     
     System.out.println("Time Sheet Action3 has been approved finally");
    }
